class Question {
  ...
  display(){
    ...
    this.question.html("Question:- George, Helen, and Steve are drinking coffee. Bert, Karen, and Dave are drinking soda.Using logic, is Elizabeth drinking coffee or soda? " );
    this.question.position(50, 60);
    this.option1.html("1:Soda" );
    this.option1.position(150, 120);
    this.option2.html("2:Coffee" );
